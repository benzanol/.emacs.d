(defun bz/window-move-right ()
  (interactive)
  (bz/window-move nil t))

(defun bz/window-move-left ()
  (interactive)
  (bz/window-move nil nil))

(defun bz/window-move-down ()
  (interactive)
  (bz/window-move t t))

(defun bz/window-move-up ()
  (interactive)
  (bz/window-move t nil))

(defun bz/window-move (vertical forward)
